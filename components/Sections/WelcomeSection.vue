<template>
  <section class="h-full py-60 bg-[#DFDFF2]">
    <div class=" ">
      <div class=" ">
        <div class="flex flex-col gap-[36px] items-center justify-between">
          ...
          <div class="" disable="false">
            <h1
              class="text-black text-8xl md:text-[90px] text-center ZENTRY-Regular font-extrabold leading-none"
            >
              <span class="">Discover the world's </span>
              <br />
              <span class="">largest shared adventure</span>
            </h1>
          </div>
        </div>
        <div class=" ">
      ...
      <!-- <div class=" ">
        <div class=" ">
          <div class="flex flex-col items-center justify-between">
            ...
            ><span
              >Immerse yourself in an IP-rich product universe where players, agentic AI
              and blockchain lead the new economic paradigm.</span
            >
          </div>
        </div>
      </div> -->
